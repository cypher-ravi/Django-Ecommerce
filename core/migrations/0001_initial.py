# Generated by Django 3.1 on 2020-09-04 08:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('S', 'Shirt'), ('SW', 'Sport Wear'), ('OW', 'Outwear')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coupon', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.coupen')),
            ],
        ),
        migrations.CreateModel(
            name='Refund',
