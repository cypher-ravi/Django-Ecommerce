...
from .models import Item, Order, OrderItem, Address, Payment, Coupen, Refund
        ...
        try:
            ...
            if form.is_valid():
                ...
                if same_billing_address:
                    ...
                    if is_valid_form([billing_address,billing_address2, billing_zip_code]):
...
class PaymentView(View):
    def get(self, *args, **kwargs):
        ...
        if order.billing_address:
            ...
            messages.warning(
                self.request, "You have not added A billing adddress")
            return redirect("core:checkout")
    ...
    def post(self, *args, **kwargs):
        ...
        try:
            ...
            # yourself an email
            messages.error(
                self.request, "Something went wrong! Your were not charged.Please Try again.")
            return redirect("/")
...
class RefundRequestedView(View):
    def get(self, *args, **kwargs):
        form = RefundForm()
        context = {
            'form': form
